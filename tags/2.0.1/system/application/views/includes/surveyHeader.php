...
<head>
   ...
   <!-- GLOBAL CSS and Javascript -->
		...
		<script src="<?php echo base_url();?>js/checkFileExtension.js" type="text/javascript"></script>
	...
	<!-- Template CSS -->
		...
		<link href="<?php echo base_url();?>css/survey.css" rel="stylesheet" type="text/css" media="screen" /> 
		<!---->
		 <!--[if IE]>
			<style>
			.item {
