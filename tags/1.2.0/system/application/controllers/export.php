 ...
 class Export extends Controller {
	...
	private function getRetentionScheduleIDs($departmentID) {
		...
		if($departmentID != 999999) {
	 	...
	 	$this->db->select('retentionScheduleID, recordCode, recordName, recordCategory, recordDescription, retentionPeriod, primaryAuthorityRetention, retentionDecisions, primaryAuthority, notes, vitalRecord, approvedByCounsel, approvedByCounselDate, officeOfPrimaryResponsibility, disposition');
