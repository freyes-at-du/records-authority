		...
		foreach ($result['response'] as $response) {
			if (is_array($response)) {
				foreach ($response as $docs) {
					...
					$retentionScheduleResults .= "<tr>";
					$retentionScheduleResults .= "<td width='15%'>";
					$retentionScheduleResults .= "<a href='/$siteName/index.php/du/getRetentionSchedule/" . $retentionScheduleID . "?height=420&width=450' class='thickbox' title='Click to view details'>$recordName</a>";
					$retentionScheduleResults .= "</td>";
