...
<?php 
	$data['title'] = 'Search Deleted Record Groups - Records Authority';
...
?>
	<div id="tabs">
		<ul>
        	<li class="ui-tabs-nav-item"><a href="#fragment-1">Search Deleted Record Groups</a></li>
        </ul>
       	
		<div id="fragment-1" class="adminForm">
        <br/><br />
			  
			<form id="searchRetentionSchedulesDeleted" method="post" action="<?php echo site_url();?>/search/getRetentionSchedulesDeleted">
				...
				&nbsp;&nbsp;
				<input name="searchRetentionSchedulesDeleted" type="submit" value="Get Deleted Record Groups" /> *<br /><br />		
			</form>
