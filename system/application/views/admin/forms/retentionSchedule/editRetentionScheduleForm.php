	...
	<div id="tabs">
       ...
       <br />
			...
			<?php 
				...
				{
					echo "<script>DateInput('approvedByCounselDate', true, 'YYYY-MON-DD', '$approvedByCounselDate')</script>";
				} else {
					echo "<script>DateInput('approvedByCounselDate', true, 'YYYY-MON-DD')</script>";
				}
			?>
