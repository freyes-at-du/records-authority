...
<?php 
	$data['title'] = 'Retention Schedule - Records Authority';
...
?>
	...
	<div id="tabs">
       ...
       <br />
			...
			<label for='recordCategory'>Record Category:&nbsp;* (Public)</label>
			<?php 
			...
			<label for='disposition'>Disposition:&nbsp;* (Public)</label><br />
			...
			<label for='Office of Primary Responsibility'>Office of Primary Responsibility: (Public)</label><br />
			...
			<input name="vitalRecord" type="radio" value="no" <?php if (isset($recordInformation['vitalRecord']) && $recordInformation['vitalRecord'] == "No") { echo "checked=\"true\""; }?> />&nbsp;No<br />
			<br />
			...
			<label for='approvedByCounselDate'>Public Retention Schedule - Approved Date:&nbsp;*</label><br />
				<!-- <input name="approvedByCounselDate" id="approvedByCounselDate" type="text" size="40" value="" /><br />-->
			<div style="width:0%;">
				<script>DateInput('approvedByCounselDate', true, 'YYYY-MON-DD')</script>
			</div>
			<br /><br />
			<br />
