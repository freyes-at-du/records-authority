...
<div id="tabs">
	<div id="setDepartment">Setting Department...</div>
       ...
       <?php if (!isset($division)) { ?>
		...
		<form id="recordInformation" method="post" action="<?php echo site_url();?>/dashboard/saveRecordTypeRecordInformation">
			...
			<input name='recordName' id='recordName' type='text' class="required" />
			<br /><br />
    ...
    <form id="formatAndLocation" method="post" action="<?php echo site_url();?>/dashboard/saveRecordTypeFormatAndLocation">
		...
		<input name="recordTypeDepartment" type="hidden" value="" /><br />
    	...
    	<form id="management" method="post" action="<?php echo site_url();?>/dashboard/saveRecordTypeManagement">
			...
			<input name="recordTypeDepartment" type="hidden" value="" /><br />
				...
				<div id="duplication">
					...
					<select id='duplicationDivisions' name='duplicationDivisionID[]' size='1'>
						<option value=''>Select a Division</option>
						<option value=''>-----------------</option>
						<?php 
							foreach ($divisionData as $id => $divisions) {
					...
					&nbsp;&nbsp;
					<select id='duplicationDepartments' name='duplicationDepartmentID[]' size='1'>
						<option value=''>departments</option>
					</select> 
					<br /><br />
					...
					25.) What department holds the master copy of these records?<br /> 
					<select id='duplicationDivisions10' name='masterCopyDivisionID' size='1' class='required'>
						<option value=''>Select a Division</option>
						<option value=''>-----------------</option>
						<?php 
							foreach ($divisionData as $id => $divisions) {
					...
					&nbsp;&nbsp;
					<select id='duplicationDepartments10' name='masterCopyDepartmentID' size='1' class='required'>
						<option value=''>departments</option>
					</select> 
					<br />
				</div>
