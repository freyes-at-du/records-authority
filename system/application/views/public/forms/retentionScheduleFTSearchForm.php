		...
		<div id="searchFullTextForm">
			<div class="searchFormFullText">
				<?php 
					...
					echo form_submit('searchRetentionSchedules', 'Search');
					...
					echo form_submit('searchAllRetentionSchedules', 'Full Schedule');
					//echo form_submit('searchRetentionSchedules', 'Search All');
					echo form_close();			
				...
				<!-- <form id="searchRetentionSchedules" method="post" action="<?php //echo site_url();?>/du/fullTextSearch"> -->
					...
					<!-- <br /><br /> -->
			     	<!-- <input type="submit" value="Search" name="searchRetentionSchedules"><br /> -->
				<!-- </form> -->
