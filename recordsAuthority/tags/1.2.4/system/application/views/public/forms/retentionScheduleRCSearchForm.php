					...
					<!--<select id='recordCategories' name='recordCategory' size='1' class='required'> 
						...
						<?php
							...
							foreach ($recordCategories as $recordCategoryID => $recordCategory) {
								if($count%4 == 0 ) {
									echo "<tr><td><input type='checkbox' id='recordCategory' name='$recordCategory' value='$recordCategory'/>&nbsp;&nbsp;$recordCategory</input></td>";
								} else {
									echo "<td><input type='checkbox' id='recordCategory' name='$recordCategory' value='$recordCategory'/>&nbsp;&nbsp;$recordCategory</input></td>";
								}
								$count = $count + 1;
							} 
							//foreach ($recordCategories as $recordCategoryID => $recordCategory) {
