...
* provides ajax functionality to liaison dashboard
*
*/
...
$('#fileFormat').autocomplete('/liaison/index.php/dashboard/autoSuggest_docTypes');	
// auto suggest used on retentionPeriod field in addRetentionScheduleForm
$('#retentionPeriod').autocomplete('/liaison/index.php/retentionSchedule/autoSuggest_retentionPeriods');
// auto suggest used on primary authority fields in addRetentionScheduleForm
$('#primaryAuthority').autocomplete('/liaison/index.php/retentionSchedule/autoSuggest_primaryAuthorities');		
// auto suggest used on primary authority retention field in addRetentionScheduleForm
$('#primaryAuthorityRetention').autocomplete('/liaison/index.php/retentionSchedule/autoSuggest_primaryAuthorityRetentions');
// auto suggest used on related authority fields in addRetentionScheduleForm
$('.relatedAuthority').autocomplete('/liaison/index.php/retentionSchedule/autoSuggest_relatedAuthorities');	
// auto suggest used on Minimum Required Retention field in addRetentionScheduleForm
$('.relatedAuthorityRetention').autocomplete('/liaison/index.php/retentionSchedule/autoSuggest_relatedAuthorityRetention');

// validates fields in retention schedule form
$("#retentionSchedule").validate();

// auto suggest used on editRecordTypeForm
$('#recordName').autocomplete('/liaison/index.php/retentionSchedule/autoSuggest_recordName');
