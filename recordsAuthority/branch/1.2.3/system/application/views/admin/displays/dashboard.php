...
<div id="tabs">
    ...
    <div class="dashboard">
		...
		<?php 
			...
			echo "<td style='text-align:left;width:100px;'>";
			echo img($imageDoc) . "&nbsp" . anchor_popup('/search/recordTypeGlobalSearch', 'Text Search - Record Inventory', $searchPopUpParams) . br();
			echo img($imageDoc) . "&nbsp" . anchor_popup('/search/retentionScheduleGlobalSearch', 'Text Search - Record Groups', $searchPopUpParams) . br();
			...
			echo img($imageDoc) . "&nbsp" . anchor('/du/retentionSchedules', 'Public Search', $shadowboxPopUpParams) . br();
			echo img($imageDoc) . "&nbsp" . anchor('/', 'Public Survey', $shadowboxPopUpParams) . br(2);
			//echo "<img src='$imagePath/ffd40f_11x11_icon_doc.gif' alt='Search' border=0 />&nbsp;" . anchor_popup('/search', 'Search', $searchPopUpParams) . "<br /><br />";
			echo "</td>";
			
			echo "<td style='text-align:left;width:100px;'>";
			echo img($imageDoc) . "&nbsp" . anchor_popup('/upload', 'Upload Files', $popUpParams) . br();
			echo img($imageDoc) . "&nbsp" . anchor_popup('/import', 'Import Retention Schedules', $popUpParams) . br(2);
			...
			//echo "<img src='$imagePath/ffd40f_11x11_icon_close.gif' alt='Logout' border=0 />&nbsp;" . anchor('login/logout', 'Logout'); 
			echo img($imageFolder) . "&nbsp" . anchor_popup('/retentionSchedule/indexRetentionSchedules', 'Index Retention Schedule', $mediumPopUpParams) . br();
			echo img($imageFolder) . "&nbsp" . anchor_popup('../solr/solrIndexer.php', 'Solr Refresh', $mediumPopUpParams) . br(2);
