...
<div id="tabs">
    ...
    <div class="dashboard">
		...
		<?php 
			//$imagePath = base_url() . "/images"; 
			echo "<img src='$imagePath/ffd40f_11x11_icon_plus.gif' alt='Create Survey' border=0 />&nbsp;" . anchor_popup('/dashboard/addSurveyName', 'Create Survey - A Form', $popUpParams) . "<br />";
			echo "<img src='$imagePath/ffd40f_11x11_icon_plus.gif' alt='Create Record Type' border=0 />&nbsp;" . anchor_popup('/dashboard/recordTypeForm', 'Create Record Type - B Form', $popUpParams) . "<br />";
			echo "<img src='$imagePath/ffd40f_11x11_icon_plus.gif' alt='Create Record Type' border=0 />&nbsp;" . anchor_popup('/dashboard/recordTypeFormRevised', 'Create Record Type - B Form Revised', $popUpParams) . "<br />";
			echo "<img src='$imagePath/ffd40f_11x11_icon_plus.gif' alt='Create Retention Schedule' border=0 />&nbsp;" . anchor_popup('/retentionSchedule/view/', 'Create Retention Schedule - C Form', $retentionSchedulePopUp) . "<br />";
