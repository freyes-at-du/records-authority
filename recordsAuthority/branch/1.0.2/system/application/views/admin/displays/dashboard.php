...
<div id="tabs">
    ...
    <div class="dashboard">
		...
		<?php 
			...
			echo "<td style='text-align:left;width:100px;'>";
			echo img($imageDoc) . "&nbsp" . anchor_popup('/search/searchRetentionSchedules', 'Search Retention Schedules', $searchPopUpParams) . br();
			echo img($imageDoc) . "&nbsp" . anchor_popup('/search/searchRecordTypes', 'Search Record Types', $searchPopUpParams) . br();
