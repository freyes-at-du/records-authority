		...
		<div id="searchFullTextForm">
			<div class="searchFormFullText">
				...
				?>
					...
					<?php
						echo anchor_popup('http://staging.du.edu/recordsmanagement/retention_sched.html', 'Retention Schedule FAQ', $searchPopUp);
						echo br(3);
						echo anchor_popup('http://staging.du.edu/media/forms/recordsmanagement/contact_us2.html', 'Have a question?', $searchPopUp);
					?>
					<!-- <br />
