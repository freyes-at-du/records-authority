    ...
    */
	public function getRecordTypes() {
		if (!empty($_POST['departmentID'])) { 
			...
			$data = $this->SearchModel->getRecordTypes($departmentID, $divisionID, $field, $sort);
            $data = array_merge($data, array( 'departmentID' => $departmentID, 'divisionID' => $divisionID, 'sortBy' => $sortBy ));
            $this->load->view('admin/displays/getRecordTypes', $data);
    ...
    */
	public function getSurveys() {
		if (!empty($_POST['departmentID'])) { 
			...
			$data = $this->SearchModel->getSurveys($departmentID, $divisionID, $field, $sort);
            $data = array_merge($data, array( 'departmentID' => $departmentID, 'divisionID' => $divisionID, 'sortBy' => $sortBy ));
            $this->load->view('admin/displays/getSurveys', $data);
		} 
	}
